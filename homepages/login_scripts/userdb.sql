DROP TABLE Users; 
DROP TABLE SinglePlay; 
DROP TABLE MultiCollab;
DROP TABLE MultiVS; 
...
CREATE TABLE SinglePlay (
    Username text Primary Key,
    HighScore int
);

CREATE TABLE MultiCollab (
    Player_1 text,
    Player_2 text,
    HighScore int,
...
INSERT INTO Users VALUES('Mitali', 'Mitali');
INSERT INTO Users VALUES('Lizzy', 'Lizzy');
INSERT INTO Users VALUES('Joanna', 'Joanna');
INSERT INTO Users VALUES('Mira', 'Mira');
